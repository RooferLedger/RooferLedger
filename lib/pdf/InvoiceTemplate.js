...
export const InvoiceDocument = ({ invoiceData }) => {
  const { invoiceId, date, clientName, subtotal, tax, total, lineItems, companyName, logoUrl, notes } = invoiceData
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View>
            {/* If a logoUrl exists, render the logo image, otherwise just render the company name text */}
            {logoUrl ? (
              <Image src={logoUrl} style={{ width: 150, height: 'auto', marginBottom: 10 }} />
            ) : (
              <Text style={styles.title}>{companyName || 'Apex Roofing'}</Text>
            )}
            <Text style={styles.companyDetails}>123 Main St, Anytown USA</Text>
            <Text style={styles.companyDetails}>support@apexroofing.com</Text>
          </View>
        ...
        <View style={styles.invoiceDetailsRow}>
          <View style={styles.clientBox}>
            ...
            <Text style={styles.valueList}>123 Client Rd</Text>
            <Text style={styles.valueList}>City, ST 12345</Text>
          </View>
