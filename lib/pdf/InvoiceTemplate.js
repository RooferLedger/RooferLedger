...
export const InvoiceDocument = ({ invoiceData }) => {
  const { invoiceId, date, clientName, clientEmail, clientPhone, subtotal, tax, total, lineItems, companyName, companyEmail, companyAddress, logoUrl, notes } = invoiceData
