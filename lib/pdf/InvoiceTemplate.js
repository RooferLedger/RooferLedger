      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View>
            ...
            {companyEmail && <Text style={styles.companyDetails}>{companyEmail}</Text>}
          </View>
        ...
        <View style={styles.invoiceDetailsRow}>
          <View style={styles.clientBox}>
            ...
            {clientEmail && <Text style={styles.valueList}>{clientEmail}</Text>}
            {clientPhone && <Text style={styles.valueList}>{clientPhone}</Text>}
          </View>
