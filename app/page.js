      ...
      <nav className="nav-bar">
        ...
        <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
          ...
          <button 
            ...
            style={{ width: 'auto', padding: '0.6rem 1.25rem', fontSize: '0.9rem', fontWeight: 'bold' }}
          >
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '3rem', position: 'relative' }}>
             ...
             <div style={{ backgroundColor: 'var(--surface)', borderRadius: '24px', padding: '3rem 2rem', textAlign: 'center', position: 'relative', border: '1px solid var(--border)', boxShadow: '0 10px 30px rgba(0,0,0,0.5)' }}>
                <div style={{ position: 'absolute', top: '-20px', left: '50%', transform: 'translateX(-50%)', backgroundColor: '#161b22', color: 'var(--primary)', width: '40px', height: '40px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '900', fontSize: '1.25rem', border: '2px solid var(--border)' }}>1</div>
                <FileText size={48} style={{ color: '#8b949e', margin: '1rem auto 2rem auto', opacity: 0.8 }} />
                <h3 style={{ color: '#fff', fontSize: '1.5rem', marginBottom: '1rem' }}>Draft on the Roof</h3>
                <p style={{ color: '#a1a1aa', lineHeight: 1.6, fontSize: '0.95rem' }}>Populate your beautiful, branded custom invoice directly from your phone while you are still inspecting the property.</p>
             </div>

             {/* Step 2 */}
             <div style={{ backgroundColor: 'var(--surface)', borderRadius: '24px', padding: '3rem 2rem', textAlign: 'center', position: 'relative', border: '1px solid var(--border)', boxShadow: '0 10px 30px rgba(0,0,0,0.5)' }}>
                <div style={{ position: 'absolute', top: '-20px', left: '50%', transform: 'translateX(-50%)', backgroundColor: '#161b22', color: 'var(--primary)', width: '40px', height: '40px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '900', fontSize: '1.25rem', border: '2px solid var(--border)' }}>2</div>
                <Smartphone size={48} style={{ color: '#8b949e', margin: '1rem auto 2rem auto', opacity: 0.8 }} />
                <h3 style={{ color: '#fff', fontSize: '1.5rem', marginBottom: '1rem' }}>One-Tap Delivery</h3>
                <p style={{ color: '#a1a1aa', lineHeight: 1.6, fontSize: '0.95rem' }}>Shoot the invoice directly to the homeowner via embedded email triggers and generate a secure Stripe payment link.</p>
             </div>
